...
/** Predefined {@link ObjectWriter}s for the placeholder external object types in {@code planesim.api}. */
public final class ObjectWriters {
    ...
    /** A radar has no velocity/heading fields to write — it's static, see {@link planesim.behavior.StaticBehavior}. */
